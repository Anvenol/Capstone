...
logger = logging.getLogger('RMD.ORCF')


def train(params, evaluate_metrics, train_loader, val_loader, test_loader):
    combined_model = Net(params, model='ORCF')
    if torch.cuda.is_available():
        combined_model.cuda()
    logger.info('Training model...')
    train_single_model(combined_model, params, evaluate_metrics, train_loader, val_loader, test_loader, 'ORCF')
